...
<body class="container text-center">
 ...
 <div class="container p-5">
   ...
   <h3 class="alert alert-secondary ">PLAN DE CALENDARIOS</h3>
  <table class="table table-striped ">
    <thead class="alert alert-secondary">
        <tr class="border border-secondary">
          <th class="fs-6 border border-secondary">ID</th>

          <th class="fs-6 border border-secondary">FECHA DE VACUNACIÒN</th>

          <th class="fs-6 border border-secondary">COMUNIDAD A VACUNAR</th>
    ...
    <tbody id="todos-list" name="todos-list">
        @foreach ($data as $plancalendario)
        <tr>
