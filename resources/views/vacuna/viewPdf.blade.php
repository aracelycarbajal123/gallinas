...
<body class="container text-center">
 ...
 <div class="container p-5">
   ...
   <h3 class="alert alert-secondary ">LOTES DE VACUNAS</h3>
  <table class="table table-striped ">
    <thead class="alert alert-secondary">
        <tr class="border border-secondary">
          <th class="fs-6 border border-secondary">ID</th>

          <th class="fs-6 border border-secondary">NOMBRE DE VACUNA</th>

          <th class="fs-6 border border-secondary">FECHA DE INGRESO</th>

          <th class="fs-6 border border-secondary">STOCK</th>

          <th class="fs-6 border border-secondary">LOTE</th>

          <th class="fs-6 border border-secondary">FECHA DE VENCIMIENTO</th>
